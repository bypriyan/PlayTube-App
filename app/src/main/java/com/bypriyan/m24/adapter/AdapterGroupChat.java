...
public class AdapterGroupChat extends RecyclerView.Adapter<AdapterGroupChat.MyHolder> {
    ...
    public AdapterGroupChat(Context context, List<ModelGroup> groupChatList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull AdapterGroupChat.MyHolder holder, int position) {
